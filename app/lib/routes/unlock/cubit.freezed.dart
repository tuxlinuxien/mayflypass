...
mixin _$UnlockFormState {
 ...
 String get username; bool get biometricUnlock; MasterPasswordValue get masterPassword; FormStatus get status;
...
@override
int get hashCode => Object.hash(runtimeType,username,biometricUnlock,masterPassword,status);

@override
String toString() {
  return 'UnlockFormState(username: $username, biometricUnlock: $biometricUnlock, masterPassword: $masterPassword, status: $status)';
}
...
@useResult
$Res call({
 String username, bool biometricUnlock, MasterPasswordValue masterPassword, FormStatus status
});
...
/// Create a copy of UnlockFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? biometricUnlock = null,Object? masterPassword = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  bool biometricUnlock,  MasterPasswordValue masterPassword,  FormStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UnlockFormState() when $default != null:
return $default(_that.username,_that.biometricUnlock,_that.masterPassword,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  bool biometricUnlock,  MasterPasswordValue masterPassword,  FormStatus status)  $default,) {final _that = this;
switch (_that) {
case _UnlockFormState():
return $default(_that.username,_that.biometricUnlock,_that.masterPassword,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  bool biometricUnlock,  MasterPasswordValue masterPassword,  FormStatus status)?  $default,) {final _that = this;
switch (_that) {
case _UnlockFormState() when $default != null:
return $default(_that.username,_that.biometricUnlock,_that.masterPassword,_that.status);case _:
  return null;
...
class _UnlockFormState implements UnlockFormState {
  const _UnlockFormState({this.username = '', this.biometricUnlock = false, this.masterPassword = const MasterPasswordValue.pure(), this.status = FormStatus.initial});
...
/// Create a copy of UnlockFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? biometricUnlock = null,Object? masterPassword = null,Object? status = null,}) {
